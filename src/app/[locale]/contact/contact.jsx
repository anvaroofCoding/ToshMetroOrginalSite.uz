...
const contactInfo = [
	...
	},
	{
		icon: Phone,
		title: "Telefon",
		content: ["Qabul xona: +998 (71) 241-65-14", "Murojaatlar uchun: +998 (71) 245-56-03"],
		delay: 0.2,
	},
	{
		icon: Clock,
	...
	return (
		<div className="min-h-screen py-16 px-4">
			<div className="container">
				...
				>
					<h2 className="text-4xl font-bold text-blue-900 mb-4">Aloqa Ma'lumotlari</h2>
					<p className="text-gray-600 text-lg max-w-2xl mx-auto">
						Bizning ofisimiz bilan bog'lanish uchun quyidagi ma'lumotlardan foydalaning
					</p>
				</motion.div>
												...
												<div className="space-y-1">
													{info.content.map((item, idx) => (
														<motion.p
															...
															transition={{ delay: info.delay + 0.5 + idx * 0.1 }}
															className="text-sm"
														>
															{item}
														</motion.p>
				...
				>
					<div className="bg-blue-50 rounded-2xl p-8 border border-blue-200">
						<h3 className="text-2xl font-bold text-blue-900 mb-4">Savollaringiz bormi?</h3>
						<p className="text-gray-700 mb-6">Bizning mutaxassislarimiz sizga yordam berishga tayyor</p>
