...
import { useBusinessDevelopmentPlansQuery } from '@/store/services/api'
import { useTranslations } from 'next-intl'

export default function BiznesRivojlanish() {
	const t = useTranslations('openData.business')
	const { data = [], isLoading, isError } = useBusinessDevelopmentPlansQuery()
