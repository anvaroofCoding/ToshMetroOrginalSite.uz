...
export default function AttoLandingPage() {
  ...
  const features = [t("one"), t("two"), t("three"), t("four")];
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center max-w-6xl mx-auto">
        ...
        >
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <p className="text-md sm:text-lg text-gray-600">{t("twelve")}</p>
          </motion.div>
          <motion.div
          ...
          >
            <a
              href="https://apps.apple.com/ru/app/atto/id1492486731"
              target="_blank"
            ...
            <a
              href="https://play.google.com/store/apps/details?id=uz.genesis.asop&hl=uz"
              target="_blank"
              rel="noopener noreferrer"
              className="transform transition-transform hover:scale-105"
            >
