...
_Generated: 2026-05-20T09:31:55.598Z_
...
Workspace `mcp.json` _(folder: ToshMetroOrginalSite.uz)_

- **c:\Users\islom\Desktop\for server copy\ToshMetroOrginalSite.uz\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\islom\.claude.json** — _File missing_
